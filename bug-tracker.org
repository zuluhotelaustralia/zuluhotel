...
* TODO weapons and armor should also be able to have skill mods
* TODO pets are slow when told to follow
* TODO taming, needs 4-6 tile range, world poorly spawned for taming, gains too slow
* DONE retaming
* TODO should not be able to provoke flayer/flenser
* DONE earth/necro books not dropping
* TODO magic clothing engine not producing items properly (rewrite)
* TODO shit is still unided after a reset -> check serialize
* DONE inscription menu is fucked
* TODO missing mana pots
* TODO health pots scale with skill/spec
* TODO heal spells scale with spec
* TODO rangers too slow fire rate/after moving
* TODO bandageself client macro sets next skill time super far in future
* TODO necro/earth books not dropping
