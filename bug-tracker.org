...
* TODO can't use ankhs because no context menu
* TODO Hood item from RP isn't showing properly on paperdoll (gumpart.mul?)
* TODO unconfirmed but probably tmaps won't work.  Gotta copy those over in gumpart.mul or whatever.  
