...
* TODO put glassblowing book into loot tables somewhere or add a GlassBlower npc vendor
* DONE up amounts of bandages, hides, bolts of cloth
* TODO re-check all skillgain rates, esp inscription 
* DONE spec-based damage isn't applying?
* TODO implement skillmod clothing
...
* TODO [DALERON] cliloc in BaseIngot.LabelNumber_get does not exist (1161034) ???
* TODO hides should say e.g. "rat hide: 20" instead of "rat: 20"
* TODO liche hides have wrong hue
* TODO lava hides have wrong hue
* TODO icecrystal hides have wrong hue
* TODO wyrm hides have wrong hue
* TODO balron hides have wrong hue
