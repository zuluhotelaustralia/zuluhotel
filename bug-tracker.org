...
* TODO bowcraftt cant choose resources/never have enough? -> test changes that were committed before going live
...
* TODO test local changes to vendors before pushing live
* TODO eliminate need for stupid ass glassblowing book
