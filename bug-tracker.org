...
* TODO "warning skillmod overwritten" in console coming from MagicClothing engine
...
* TODO dragon leather no prots?  check all leather
* TODO ebless and other spells not working??
* TODO warriors seem not to be able to damage each other
...
* TODO make it so spec crafter is required to have a chance at exceptional for anything above dripstone
* TODO seems that people can cast spells holding shields and weapons
...
* TODO rangers get fucked on maxskills for spec because tactics
* TODO kill spell is OP
