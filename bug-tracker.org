...
* TODO fix start location minimap
* TODO weird ass tiles all over the place
* TODO doorgen doesn't work
* TODO missing regions when loading regions.xml (dummy classes)
* TODO rename e.g. Pedran to "New Britain" and other shit.
