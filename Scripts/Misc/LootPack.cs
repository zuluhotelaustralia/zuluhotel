...
namespace Server
{
    public class LootPack
	{
		...
		public static readonly LootPackItem[] DefaultMagicItems = new[]
			{
		...
		public static readonly LootPack DefaultPoor = new LootPack( new[]
			{
				new LootPackEntry(  true, Gold,			100.00, "1d25" ),
				new LootPackEntry( false, Instruments,	  0.02, 1 )
			} );

		public static readonly LootPack DefaultMeager = new LootPack( new[]
			{
				new LootPackEntry(  true, Gold,			100.00, "5d10+25" ),
				new LootPackEntry( false, Instruments,	  0.10, 1 ),
				new LootPackEntry( false, DefaultMagicItems,  1.00, 1, 1, 0, 60 ),
				new LootPackEntry( false, DefaultMagicItems,  0.20, 1, 1, 10, 70 )
			} );

		public static readonly LootPack DefaultAverage = new LootPack( new[]
			{
				new LootPackEntry(  true, Gold,			100.00, "10d10+50" ),
				new LootPackEntry( false, Instruments,	  0.40, 1 ),
				new LootPackEntry( false, DefaultMagicItems,  5.00, 1, 1, 20, 80 ),
				new LootPackEntry( false, DefaultMagicItems,  2.00, 1, 1, 30, 90 ),
				new LootPackEntry( false, DefaultMagicItems,  0.50, 1, 1, 40, 100 )
			} );

		public static readonly LootPack DefaultRich = new LootPack( new[]
			{
				new LootPackEntry(  true, Gold,			100.00, "10d10+250" ),
				new LootPackEntry( false, Instruments,	  1.00, 1 ),
				new LootPackEntry( false, DefaultMagicItems, 20.00, 1, 1, 60, 100 ),
				new LootPackEntry( false, DefaultMagicItems, 10.00, 1, 1, 65, 100 ),
				new LootPackEntry( false, DefaultMagicItems,  1.00, 1, 1, 70, 100 )
			} );

		public static readonly LootPack DefaultFilthyRich = new LootPack( new[]
			{
				new LootPackEntry(  true, Gold,			100.00, "2d125+400" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
				new LootPackEntry( false, DefaultMagicItems, 33.00, 1, 1, 50, 100 ),
				new LootPackEntry( false, DefaultMagicItems, 33.00, 1, 1, 60, 100 ),
				new LootPackEntry( false, DefaultMagicItems, 20.00, 1, 1, 70, 100 ),
				new LootPackEntry( false, DefaultMagicItems,  5.00, 1, 1, 80, 100 )
			} );

		public static readonly LootPack DefaultUltraRich = new LootPack( new[]
			{
				new LootPackEntry(  true, Gold,			100.00, "5d100+500" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
				new LootPackEntry( false, DefaultMagicItems,	100.00, 1, 1, 40, 100 ),
				new LootPackEntry( false, DefaultMagicItems,	100.00, 1, 1, 40, 100 ),
				new LootPackEntry( false, DefaultMagicItems,	100.00, 1, 1, 50, 100 ),
				new LootPackEntry( false, DefaultMagicItems,	100.00, 1, 1, 50, 100 ),
				new LootPackEntry( false, DefaultMagicItems,	100.00, 1, 1, 60, 100 ),
				new LootPackEntry( false, DefaultMagicItems,	100.00, 1, 1, 60, 100 )
			} );

		public static readonly LootPack DefaultSuperBoss = new LootPack( new[]
			{
				new LootPackEntry(  true, Gold,			100.00, "5d100+500" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
				new LootPackEntry( false, DefaultMagicItems,	100.00, 1, 1, 40, 100 ),
				...
				new LootPackEntry( false, DefaultMagicItems,	100.00, 1, 1, 60, 100 ),
				new LootPackEntry( false, DefaultMagicItems,	100.00, 1, 1, 60, 100 ),
				new LootPackEntry( false, DefaultMagicItems,	100.00, 1, 1, 70, 100 )
			} );
		#endregion

		#region Generic accessors
		public static LootPack Poor{ get{ return DefaultPoor; } }
		public static LootPack Meager{ get{ return DefaultMeager; } }
		public static LootPack Average{ get{ return DefaultAverage; } }
		public static LootPack Rich{ get{ return DefaultRich; } }
		public static LootPack FilthyRich{ get{ return DefaultFilthyRich; } }
		public static LootPack UltraRich{ get{ return DefaultUltraRich; } }
		public static LootPack SuperBoss{ get{ return DefaultSuperBoss; } }
		#endregion
	...
	public class LootPackEntry
	{
		...
		private int GetRandomDefaultBonus()
		{
				...
				if ( item is BaseWeapon || item is BaseArmor || item is BaseJewel || item is BaseHat )
				{
					if ( item is BaseWeapon )
					{
						...
						if ( 80 > Utility.Random( 100 ) )
							weapon.AccuracyLevel = (WeaponAccuracyLevel)GetRandomDefaultBonus();

						if ( 60 > Utility.Random( 100 ) )
							weapon.DamageLevel = (WeaponDamageLevel)GetRandomDefaultBonus();
					...
					else if ( item is BaseArmor )
					{
						...
						if ( 80 > Utility.Random( 100 ) )
							armor.ProtectionLevel = (ArmorProtectionLevel)GetRandomDefaultBonus();

						if ( 40 > Utility.Random( 100 ) )
							armor.Durability = (ArmorDurabilityLevel)GetRandomDefaultBonus();
					}
				}
