...
namespace Server.Mobiles
{
    ...
    {
        static ShadowDragon() => CreatureProperties.Register<ShadowDragon>(new CreatureProperties
        {
            ...
            Tamable = false,
            VirtualArmor = 20,
            WeaponAbility = new SpellStrike<RunZH.Scripts.Zulu.Spells.Necromancy.DecayingRaySpell>(),
