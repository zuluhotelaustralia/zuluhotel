...
namespace Server.Mobiles
{
    ...
    {
        static FrostDragon() => CreatureProperties.Register<FrostDragon>(new CreatureProperties
        {
            // cast_pct = 40,
            ...
            Tamable = true,
            VirtualArmor = 40,
            WeaponAbility = new SpellStrike<RunZH.Scripts.Zulu.Spells.Earth.IceStrikeSpell>(),
