...
namespace Server.Mobiles
{
    ...
    {
        static InfernoDragon() => CreatureProperties.Register<InfernoDragon>(new CreatureProperties
        {
            // cast_pct = 40,
            ...
            Tamable = true,
            VirtualArmor = 40,
            WeaponAbility = new SpellStrike<RunZH.Scripts.Zulu.Spells.Earth.RisingFireSpell>(),
