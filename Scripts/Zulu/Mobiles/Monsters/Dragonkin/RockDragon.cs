...
namespace Server.Mobiles
{
    ...
    {
        static RockDragon() => CreatureProperties.Register<RockDragon>(new CreatureProperties
        {
            // cast_pct = 40,
            ...
            Tamable = true,
            VirtualArmor = 50,
            WeaponAbility = new SpellStrike<RunZH.Scripts.Zulu.Spells.Earth.ShiftingEarthSpell>(),
