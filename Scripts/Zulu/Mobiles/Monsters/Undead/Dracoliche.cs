...
namespace Server.Mobiles
{
    ...
    {
        static Dracoliche() => CreatureProperties.Register<Dracoliche>(new CreatureProperties
        {
            // cast_pct = 20,
            ...
            Tamable = true,
            VirtualArmor = 40,
            WeaponAbility = new SpellStrike<RunZH.Scripts.Zulu.Spells.Necromancy.WraithBreathSpell>(),
