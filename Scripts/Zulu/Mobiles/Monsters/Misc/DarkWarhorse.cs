...
{
    public class DarkWarhorse : BaseCreature
    {
        static DarkWarhorse() => CreatureProperties.Register<DarkWarhorse>(new CreatureProperties
        {
        ...
        [Constructable]
        public DarkWarhorse() : base(CreatureProperties.Get<DarkWarhorse>())
        {
        ...
        public DarkWarhorse(Serial serial) : base(serial) {}
