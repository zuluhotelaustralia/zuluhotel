...
namespace Server.Mobiles
{
    public partial class BaseCreature : Mobile
    {
        ...
        public virtual void BreathEffect_Callback(object state)
        {
            ...
            Timer.DelayCall(TimeSpan.FromSeconds(BreathDamageDelay), new TimerStateCallback(BreathDamage_Callback),
                target);
        }
        ...
        */
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            ...
            /* Begin notice sound */
            if ((!m.Hidden || m.AccessLevel == AccessLevel.Player) && m.Player && m_FightMode != FightMode.Aggressor &&
                m_FightMode != FightMode.None && Combatant == null && !Controlled && !Summoned)
            {
        ...
        public virtual void OnThink()
        {
            ...
            if ((CanHeal || CanHealOwner) && Alive && !IsHealing && !BardPacified)
            {
                ...
                if (owner != null && CanHealOwner && DateTime.Now >= m_NextHealOwnerTime &&
                ...
                else if (CanHeal && DateTime.Now >= m_NextHealTime && CanBeBeneficial(this) &&
        ...
        {
            get { return m_SeeksHome && Home != Point3D.Zero && !m_ReturnQueued && !Controlled && !Summoned; }
        }
