namespace Server.Gumps
{
	...
	{
		public static readonly bool DefaultStyle = false;
		...
		public static readonly int HeaderGumpID = DefaultStyle ? 0x0BBC : 0x0E14; // Light offwhite, textured : Dark navy blue, textured
		...
		public static readonly int    SetGumpID = DefaultStyle ? 0x0000 : 0x0E14; // Empty : Dark navy blue, textured

		public static readonly int SetWidth = 20;
		public static readonly int SetOffsetX = DefaultStyle ? 4 : 2, SetOffsetY = 2;
