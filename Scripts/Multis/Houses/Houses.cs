...
{
    public class SmallDefaultHouse : BaseHouse
	{
		...
		public SmallDefaultHouse( Mobile owner, int id ) : base( id, owner, 425, 3 )
		{
		...
		public SmallDefaultHouse( Serial serial ) : base( serial )
		{
		}
