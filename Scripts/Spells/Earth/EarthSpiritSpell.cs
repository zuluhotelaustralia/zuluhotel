...
{
    public class EarthSpiritSpell : Spell
    {
        private static SpellInfo m_Info = new SpellInfo(
                "Earth Spirit", "Chame A Terra Elemental"
                );
        ...
        public void Target( Mobile m )
        {
            ...
            if ( ! m.BeginAction( typeof( EarthSpiritSpell ) ) ) {
                goto Return;
            }
        ...
        private class InternalTimer : Timer
        {
            ...
            {
                m_Target.EndAction( typeof( EarthSpiritSpell ) );
            }
        }

        private class InternalTarget : Target
        {
            private EarthSpiritSpell m_Owner;

            // TODO: What is thie Core.ML stuff, is it needed?
            public InternalTarget( EarthSpiritSpell owner ) : base( Core.ML ? 10 : 12, false, TargetFlags.Harmful )
            {
                m_Owner = owner;
            }
