...
namespace Server.Spells.Earth
{
    public class SummonMammalsSpell : AbstractEarthSpell
    {
        ...
        private class InternalTimer : Timer
        {
            ...
            {
                m_Target.EndAction( typeof( SummonMammalsSpell ) );
            }
        }

        private class InternalTarget : Target
        {
            private SummonMammalsSpell m_Owner;

            // TODO: What is thie Core.ML stuff, is it needed?
            public InternalTarget( SummonMammalsSpell owner ) : base( Core.ML ? 10 : 12, false, TargetFlags.Harmful )
            {
                m_Owner = owner;
            }
