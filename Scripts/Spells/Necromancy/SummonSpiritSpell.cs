...
namespace Server.Spells.Necromancy
{
    public class SummonSpiritSpell : NecromancerSpell
    {
        ...
        public void Target( Mobile m )
        {
            ...
            if ( ! m.BeginAction( typeof( SummonSpiritSpell ) ) ) {
                goto Return;
            }
        ...
        private class InternalTimer : Timer
        {
            ...
            {
                m_Target.EndAction( typeof( SummonSpiritSpell ) );
            }
        }

        private class InternalTarget : Target
        {
            private SummonSpiritSpell m_Owner;

            // TODO: What is thie Core.ML stuff, is it needed?
            public InternalTarget( SummonSpiritSpell owner ) : base( Core.ML ? 10 : 12, false, TargetFlags.Harmful )
            {
                m_Owner = owner;
            }
