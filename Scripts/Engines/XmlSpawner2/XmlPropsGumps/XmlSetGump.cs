...
namespace Server.Gumps
{
	public class XmlSetGump : Gump
	{
		...
		public XmlSetGump( PropertyInfo prop, Mobile mobile, object o, Stack stack, int page, ArrayList list ) : base( GumpOffsetX, GumpOffsetY )
		{
			...
			AddImageTiled( BorderSize, BorderSize, TotalWidth+xextend - (DefaultStyle ? SetWidth + OffsetSize : 0), TotalHeight + (canNull ? EntryHeight + OffsetSize : 0) + (canDye ? EntryHeight + OffsetSize : 0) + (isBody ? EntryHeight + OffsetSize : 0), OffsetGumpID );
