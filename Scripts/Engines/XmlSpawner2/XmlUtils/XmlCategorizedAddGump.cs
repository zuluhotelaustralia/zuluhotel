...
namespace Server.Gumps
{
	...
	public class XmlCategorizedAddGump : Gump
	{
		...
		public void Initialize( int page )
		{
			...
			int emptyWidth = TotalWidth - PrevWidth * 2 - NextWidth - OffsetSize * 5 - (DefaultStyle ? SetWidth + OffsetSize : 0);

			if ( !DefaultStyle )
				AddImageTiled( x - (DefaultStyle ? OffsetSize : 0), y, emptyWidth + (DefaultStyle ? OffsetSize * 2 : 0), EntryHeight, EntryGumpID );
