...
namespace Server.Engines.Harvest
{
        public class MiningResources
        {
                ...
                {
                        new HarvestResource( 0.00, 0.00, 100.00, 1007072, typeof( ZuluIronOre ), typeof( Granite ) ),
                        new HarvestResource( 10.00, 10.00, 100.00, 1007072, typeof( ZuluDullCopperOre ), typeof( Granite ) ),
                };
