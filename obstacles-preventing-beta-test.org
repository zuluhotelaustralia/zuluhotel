...
* TODO finish off GatherSystem: [[oretable]] [[logtable]] [[hidetable]] [85/86]
:PROPERTIES:
...
* TODO Items to tackle after launching beta but before "1.0" [10/24]
:properties:
:cookie_data: todo recursive
:end:
** TODO Fix gathersystem timing so it awards resources after the animation plays
