...
* TODO finish off GatherSystem: [[oretable]] [[logtable]] [[hidetable]] [66/78]
:PROPERTIES:
...
** TODO resource hues, names, and properties propagate to crafted items
*** TODO finish BaseArmor:  needs name prefix, and armor rating, and possibly durability
**** TODO name prefix (clilocs), see AddNameProperty and OnCraft.  When does AddNameProperty actually get called?
**** DONE hue
**** DONE armor rating
*** TODO change all appropriate ICraftables to take hue, resource name prefix, and quality as required (see BaseArmor.OnCraft for example)
**** TODO baseharvesttool
**** TODO basetool
**** TODO spellbook
**** TODO runebook
**** TODO baseinstrument
**** TODO baseweapon
**** TODO baselockablecontainer ?
...
* TODO Items to tackle after launching beta but before "1.0" [0/12]
:properties:
:cookie_data: todo recursive
:end:
