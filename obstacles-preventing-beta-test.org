...
* TODO finish off GatherSystem: [[oretable]] [[logtable]] [[hidetable]] [63/65]
:PROPERTIES:
...
* TODO finish off Necro and Earth magic [3/5]
:PROPERTIES:
:COOKIE_DATA: todo recursive
:END:
...
** TODO fix spell scroll item names (itemID parameter)
* DONE implement skillgain rate scaling based on player's region [6/7]
:PROPERTIES:
:COOKIE_DATA: todo recursive
:END:
...
*** TODO check server/skills.cs for proper operation of Skill.Value because there are references to "100.0" in there
...
* TODO Items to tackle after launching beta but before "1.0" [0/11]
:properties:
:cookie_data: todo recursive
:end:
