...
* TODO finish off GatherSystem: [[oretable]] [[logtable]] [[hidetable]] [63/67]
:PROPERTIES:
...
** DONE resource hues
** TODO resource properties (quality multiplier for AR or damage)
...
*** TODO change all appropriate ICraftables to take hue (see BaseArmor.OnCraft for example)
