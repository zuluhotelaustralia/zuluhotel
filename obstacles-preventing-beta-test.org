...
* TODO final sanity-checks [15/28]
:properties:
:cookie_data: todo_recursive
:end:
** TODO disable or silently convert characters to defaults if they try to generate a character with ninjitsu or something, same with elves
...
** TODO Chests by first skeletal mage spawns circle 1-6 scrolls in fire dungeon
** TODO cut robes for bandages
** TODO Decide if we want to remove Bolas
...
** TODO and earth scrolls
** TODO and the books for earth and necro
** TODO playtest gathering to ensure it's actually within the realm of viable
** TODO looks like there's a bug in the lumberjacking gump to do with categorizing your log types
** DONE implement [spec
...
* TODO Items to tackle after launching beta but before "1.0" [13/31]
:properties:
:cookie_data: todo recursive
:end:
