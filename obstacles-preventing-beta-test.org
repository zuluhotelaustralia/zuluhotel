...
* DONE final sanity-checks [26/26]
:properties:
...
* TODO Items to tackle after launching beta but before "1.0" [35/36]
:properties:
:cookie_data: todo recursive
:end:
...
** DONE auction house that takes a 10% cut (ish)
...
** DONE make sure pagans are spawning in loot
   You can buy them from vendors -> gold sink
...
** DONE fix baseweapon/basearmor exceptional quality stuff (Core.AOS)
** DONE figure out how jail works in runuo - there seems to be no [jail command
*** DONE and so that once you hit a vein you stay on it until you fail, let's say. (m_Veins list on controller perhaps)
** DONE hides
** DONE missing monsters [7/7]
*** DONE make unique mobs for that fucked up blood dungeon
*** DONE make unique mobs for chicane
*** DONE make goblins for the mine dungeon
*** DONE make crazy miner per daleron's idea
*** DONE Golden Dragon
*** DONE ostards
*** DONE ratmen?
...
** DONE check SpellHelper.CheckTravel for beta remnants
