...
* TODO Items to tackle after launching beta but before "1.0" [26/47]
:properties:
:cookie_data: todo recursive
:end:
...
*** TODO and so that once you hit a vein you stay on it until you fail, let's say. (m_Veins list on controller perhaps)
** DONE hides
