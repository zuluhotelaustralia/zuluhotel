...
* TODO finish off GatherSystem: [[oretable]] [[logtable]] [[hidetable]] [70/80]
:PROPERTIES:
...
** TODO add logs and granite names to clilocs
...
* TODO Items to tackle after launching beta but before "1.0" [0/18]
:properties:
:cookie_data: todo recursive
:end:
...
** TODO anti corruption code [0/3]
*** TODO log items created by staff
*** TODO log edits done to characters by staff
