...
* TODO final sanity-checks [3/12]
:properties:
:cookie_data: todo_recursive
:end:
** TODO playtest gathering to ensure it's actually within the realm of viable
** TODO implement [spec
** TODO playtest taking e.g. a warrior from newbie to spec 1 without macroing
** TODO perform minimal spawning of Serpent's Hold and perhaps the Fire Dungeon
** TODO does dispel not kill buffs/debuffs?
** TODO a whole 2nd set of implicit skillcaps re: code passing minSkill and maxSkill to the handler functions
*** TODO ensure timelines/gain rates for stats and skills are legit
**** DONE make baseregion decent gain, like a=0.03, then slow it down in houses to 0.0005
**** TODO for above, maybe don't make combat quite as fast but definitely speed up e.g. taming and healing and stuff
**** TODO macefighting, parrying, and possibly a few others don't gain properly
*** DONE stats too
** DONE figure out why teleporters (i.e. cave doors, stairs, moongates) don't work

* TODO Items to tackle after launching beta but before "1.0" [13/29]
:properties:
:cookie_data: todo recursive
:end:
...
* Bugs Discovered in Alpha
** TODO Criminal to loot spider?
   Maybe criminal to loot somebody elses kill
** TODO Cliloc errors on all armor
   Leahter, bone, etc.
   Weird shit really.
** DONE add vendor who sells bandages
** TODO Chests by first skeletal mage spawns regs in fire dungeon
** TODO cut robes for bandages
** TODO dispel curses
** TODO Remove Bola Balls
** TODO Add alchemist who sells useful potions for warriors?
** TODO Bump up quantity of items in vendors, particularly regs/bandies
** TODO Add a vendor who sells pagan regs
** TODO Disable concussion blow
