...
* TODO finish off GatherSystem: [[oretable]] [[logtable]] [[hidetable]] [26/60]
:PROPERTIES:
...
** TODO turns out we gotta generate the logs:  make and awk here we go fuckers
...
*** TODO Items/Misc/ClockworkAssembly.cs
*** TODO Items/Misc/PowerGenerator.cs
*** TODO Items/Resources/Blacksmithing/BaseIngot.cs
*** TODO Items/Resources/Blacksmithing/Generated/BaseOre.cs
*** TODO Items/Resources/Masonry/Granite.cs
*** TODO Items/Special/Bulk Order Rewards/Blacksmithy/ColoredAnvil.cs
*** TODO Items/Special/Bulk Order Rewards/Blacksmithy/GlovesOfMining.cs
*** TODO Items/Special/Veteran Rewards/MiningCart.cs
*** TODO Items/Weapons/BaseWeapon.cs
*** TODO Misc/CharacterCreation.cs
*** TODO Mobiles/Monsters/Ants/AntLion.cs
*** TODO Mobiles/Monsters/Humanoid/Melee/OrcBrute.cs
*** TODO Mobiles/Monsters/LBR/Jukas/ChaosDragoonElite.cs
*** TODO Mobiles/Monsters/Ore Elementals/AgapiteElemental.cs
*** TODO Mobiles/Monsters/Ore Elementals/BronzeElemental.cs
*** TODO Mobiles/Monsters/Ore Elementals/CopperElemental.cs
*** TODO Mobiles/Monsters/Ore Elementals/GoldenElemental.cs
*** TODO Mobiles/Monsters/Ore Elementals/ShadowIronElemental.cs
*** TODO Mobiles/Monsters/Ore Elementals/ValoriteElemental.cs
*** TODO Mobiles/Monsters/Ore Elementals/VeriteElemental.cs
*** TODO SpecialSystems/Items/SupplyBags/BagOfIngots.cs
*** TODO SpecialSystems/Items/SupplyBags/SmithBag.cs
** DONE autolooping
*** DONE implement autoloop variable on mobile
*** DONE add looping check in GatherTimer
** TODO play the animations/soundfx
** TODO make an analogue to Scripts/Engines/Harvest/Generated/MiningResources.cs for lumberjacking
*** TODO remove special log and board classes
*** TODO mkdir Generated/
*** TODO put new ones in, reference them via GatherSystem
*** TODO use idea from parent item to move them all to a new file for HarvestSystem
...
* TODO make sure Spec actually works [6/13]
:PROPERTIES:
:COOKIE_DATA: todo recursive
:END:
** DONE damage taken
