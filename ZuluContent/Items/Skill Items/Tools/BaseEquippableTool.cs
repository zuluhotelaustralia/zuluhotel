...
public abstract class BaseEquippableTool : BaseTool, IMagicItem
{
    ...
    public BaseEquippableTool(int itemID) : base(itemID)
    {
    }

    public BaseEquippableTool(int uses, int itemID) : base(itemID)
    {
    }

    public BaseEquippableTool(Serial serial) : base(serial)
    {
    }
