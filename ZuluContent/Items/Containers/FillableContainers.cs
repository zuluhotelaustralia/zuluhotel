...
namespace Server.Items
{
    public abstract class FillableContainer : LockableContainer
    {
        ...
        {
            bool canSpawn = m_Content != null && !Deleted && GetItemsCount() <= SpawnThreshold && !Movable &&
    ...
    public class FillableEntry
    {
        ...
        public FillableEntry(int weight, Type type, int itemID) : this(weight, new[] {type}, itemID)
        {
        }
        ...
        public virtual Item Construct()
        {
            ...
            if (item is Key)
                ((Key) item).ItemID = Utility.RandomList((int) KeyType.Copper, (int) KeyType.Gold, (int) KeyType.Iron,
                    (int) KeyType.Rusty);
    ...
    public class FillableContent
    {
        ...
        public static FillableContent Clothier = new FillableContent(
            ...
            new[]
            {
                ...
                new FillableEntry(2, typeof(Hide))
            });
