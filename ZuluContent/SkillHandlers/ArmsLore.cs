...
namespace Server.SkillHandlers
{
	public class ArmsLore : BaseSkillHandler
	{
        ...
        [PlayerVendorTarget]
        public class ArmsLoreTarget : AsyncTarget<Item>
        {
        ...
        public override async Task<TimeSpan> OnUse(Mobile from)
		{
            ...
            switch (targeted)
                {
                    case BaseWeapon weapon when from.CheckTargetSkill( SkillName.ArmsLore, weapon, 0, 100 ):
                    {
                    ...
                    case BaseWeapon:
                        ...
                        break;
                    case BaseArmor armor when from.CheckTargetSkill(SkillName.ArmsLore, armor, 0, 100):
                    {
                        var arm = armor;
