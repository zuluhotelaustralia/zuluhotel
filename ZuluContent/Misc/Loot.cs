...
namespace Server
{
  public class Loot
  {
    ...
    private static Type[] m_DefaultWandTypes = new[]
    {
      typeof(IDWand)
    };

    public static Type[] DefaultWandTypes
    {
      get { return m_DefaultWandTypes; }
    }
    ...
    {
      return Construct(m_DefaultWandTypes, m_WandTypes, m_NewWandTypes) as BaseWand;
    }
