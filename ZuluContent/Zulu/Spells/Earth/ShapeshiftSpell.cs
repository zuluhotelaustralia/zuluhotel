...
namespace Scripts.Zulu.Spells.Earth
{
  ...
  public class ShapeshiftSpell : AbstractEarthSpell
  {
    ...
    public override SpellInfo GetSpellInfo() => Info;

    private static readonly SpellInfo Info = new SpellInfo(
    ...
    public ShapeshiftSpell(Mobile caster, Item scroll) : base(caster, scroll, Info)
    {
    }

    public ShapeshiftSpell(Mobile caster, Item scroll, Entry entry) : base(caster, scroll, Info)
    {
      m_NewBody = entry;
    }
