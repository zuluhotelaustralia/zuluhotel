...
{
    public class WaterWarhorse : BaseCreature
    {
        static WaterWarhorse() => CreatureProperties.Register<WaterWarhorse>(new CreatureProperties
        {
        ...
        [Constructible]
public WaterWarhorse() : base(CreatureProperties.Get<WaterWarhorse>())
        {
        ...
        [Constructible]
public WaterWarhorse(Serial serial) : base(serial) {}
