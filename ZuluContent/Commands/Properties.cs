...
namespace Server.Commands
{
    ...
    public static class Properties
    {
        ...
        public static PropertyInfo GetPropertyInfo(Mobile from, ref object obj, string propertyName,
...
namespace Server
{
    ...
    {
        public ClearanceException(Property property, AccessLevel playerAccess, AccessLevel neededAccess,
            string accessType)
            : base(property,
    ...
    public sealed class Property
    {
        ...
        public bool CheckAccess(Mobile from)
        {
            ...
            for (int i = 0; i < m_Chain.Length; ++i)
            {
                ...
                if ((access & PropertyAccess.Write) != 0 &&
