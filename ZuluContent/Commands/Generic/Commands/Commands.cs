...
namespace Server.Commands.Generic
{
    public class TargetCommands
    {
        ...
        public static void Initialize()
        {
            ...
            Register(new AliasedSetCommand(AccessLevel.GameMaster, "Squelch", "Squelched", "true",
                ObjectTypes.Mobiles));
            Register(new AliasedSetCommand(AccessLevel.GameMaster, "Unsquelch", "Squelched", "false",
                ObjectTypes.Mobiles));

            Register(new AliasedSetCommand(AccessLevel.GameMaster, "ShaveHair", "HairItemID", "0",
                ObjectTypes.Mobiles));
    ...
    public class TellCommand : BaseCommand
    {
        ...
        public override void Execute(CommandEventArgs e, object obj)
        {
            ...
            CommandLogging.WriteLine(from, "{0} {1} {2} {3} \"{4}\"", from.AccessLevel, CommandLogging.Format(from),
                m_InGump ? "messaging" : "telling", CommandLogging.Format(mob), e.ArgString);
    ...
    public class TeleCommand : BaseCommand
    {
        ...
        public override void Execute(CommandEventArgs e, object obj)
        {
            ...
            if (!from.Hidden)
            {
                Effects.SendLocationParticles(EffectItem.Create(fromLoc, from.Map, EffectItem.DefaultDuration), 0x3728,
                    10,
                    10, 2023);
                Effects.SendLocationParticles(EffectItem.Create(toLoc, from.Map, EffectItem.DefaultDuration), 0x3728,
                    10, 10,
                    5023);
    ...
    public class RestockCommand : BaseCommand
    {
        ...
        public override void Execute(CommandEventArgs e, object obj)
        {
            ...
            {
                CommandLogging.WriteLine(e.Mobile, "{0} {1} restocking {2}", e.Mobile.AccessLevel,
                    CommandLogging.Format(e.Mobile), CommandLogging.Format(vendor));
    ...
    public class DeleteCommand : BaseCommand
    {
        ...
        public override void Execute(CommandEventArgs e, object obj)
        {
            if (obj is Item item)
            {
                CommandLogging.WriteLine(e.Mobile, "{0} {1} deleting {2}", e.Mobile.AccessLevel,
                    CommandLogging.Format(e.Mobile), CommandLogging.Format(item));
                item.Delete();
            ...
            {
                CommandLogging.WriteLine(e.Mobile, "{0} {1} deleting {2}", e.Mobile.AccessLevel,
                    CommandLogging.Format(e.Mobile), CommandLogging.Format(mobile));
                mobile.Delete();
    ...
    public class HideCommand : BaseCommand
    {
        ...
        public override void Execute(CommandEventArgs e, object obj)
        {
            ...
            CommandLogging.WriteLine(e.Mobile, "{0} {1} {2} {3}", e.Mobile.AccessLevel, CommandLogging.Format(e.Mobile),
                m_Value ? "hiding" : "unhiding", CommandLogging.Format(m));
    ...
    public class FirewallCommand : BaseCommand
    {
        ...
        public override void Execute(CommandEventArgs e, object obj)
        {
            ...
            if (state != null)
            {
                CommandLogging.WriteLine(from, "{0} {1} firewalling {2}", from.AccessLevel, CommandLogging.Format(from),
        ...
        public override void Execute(CommandEventArgs e, object obj)
        {
            ...
            if (from.AccessLevel > targ.AccessLevel)
            {
                ...
                if (fromState != null && targState != null)
                {
                    ...
                    {
                        CommandLogging.WriteLine(from, "{0} {1} {2} {3}", from.AccessLevel, CommandLogging.Format(from),
                            m_Ban ? "banning" : "kicking", CommandLogging.Format(targ));
