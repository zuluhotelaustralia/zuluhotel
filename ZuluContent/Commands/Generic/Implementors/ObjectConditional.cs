...
namespace Server.Commands.Generic
{
    public sealed class ObjectConditional
    {
        ...
        public bool IsItem
        {
            get { return Type == null || Type == typeofItem || Type.IsSubclassOf(typeofItem); }
        }

        public bool IsMobile
        {
            get { return Type == null || Type == typeofMobile || Type.IsSubclassOf(typeofMobile); }
        }
        ...
        public static ObjectConditional ParseDirect(Mobile from, string[] args, int offset, int size)
        {
            ...
            var objectType = AssemblyHandler.FindTypeByName(args[offset + index], true);
