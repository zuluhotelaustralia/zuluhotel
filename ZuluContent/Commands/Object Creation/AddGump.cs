...
namespace Server.Gumps
{
    public class AddGump : Gump
    {
        ...
        public AddGump(Mobile from, string searchString, int page, Type[] searchResults, bool explicitSearch) : base(50,
            50)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                default:
                {
                    ...
                    if (index >= 0 && index < m_SearchResults.Length)
                    {
                        ...
                        from.Target = new InternalTarget(m_SearchResults[index], m_SearchResults, m_SearchString,
                            m_Page);
                    }
