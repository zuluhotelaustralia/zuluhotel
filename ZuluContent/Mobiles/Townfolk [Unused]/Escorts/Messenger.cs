...
public Messenger()
		...
		public override void InitOutfit()
		{
			...
			{
				case 0: AddItem( new ShortHair( Race.RandomHairHue() ) ); break;
				case 1: AddItem( new TwoPigTails( Race.RandomHairHue() ) ); break;
				case 2: AddItem( new ReceedingHair( Race.RandomHairHue() ) ); break;
				case 3: AddItem( new KrisnaHair( Race.RandomHairHue() ) ); break;
			}
