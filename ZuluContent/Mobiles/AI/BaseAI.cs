...
namespace Server.Mobiles
{
    ...
    public abstract class BaseAI
    {
        ...
        {
            if (Core.TickCount < m_NextStopGuard)
            {
        ...
        public virtual bool DoOrderGuard()
        {
            ...
            if (combatant != null && combatant != m_Mobile && combatant != m_Mobile.ControlMaster &&
                !combatant.Deleted && combatant.Alive && m_Mobile.CanSee(combatant) &&
        ...
        {
            if (DateTime.Now >= m_Mobile.BardEndTime && (m_Mobile.BardMaster == null || m_Mobile.BardMaster.Deleted ||
        ...
        public double TransformMoveDelay(double delay)
        {
            ...
            if (double.IsNaN(delay))
            {
                ...
                {
                    op.WriteLine(String.Format("NaN in TransformMoveDelay: {0}, {1}, {2}, {3}", DateTime.Now,
                        this.GetType().ToString(), m_Mobile == null ? "null" : m_Mobile.GetType().ToString(),
                        m_Mobile.HitsMax));
                }
        ...
        public virtual void WalkRandomInHome(int iChanceToNotMove, int iChanceToDir, int iSteps)
        {
            ...
            if (m_Mobile.Home == Point3D.Zero)
            {
                ...
                {
                    Region region = m_Mobile.Spawner.Region;
        ...
        private class AITimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                if (m_Owner.CanDetectHidden && Core.TickCount > m_Owner.m_NextDetectHidden)
                {
