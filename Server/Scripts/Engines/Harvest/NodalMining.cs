...
{
    public class NodalMining : GatherSystem
    {
	private static NodalMining m_System;
	...
	public static NodalMining System
	{
	    get
	    {
		if ( m_System == null )
		    m_System = new NodalMining();
	...
	public override void OnBadGatherTarget( Mobile from, Item tool, object toHarvest )
	{
	...
	public override bool CheckHarvest( Mobile from, Item tool, object toHarvest )
	{
