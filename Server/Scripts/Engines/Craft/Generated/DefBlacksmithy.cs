...
namespace Server.Engines.Craft
{
	...
	public override void InitCraftList()
	{
	    ...
	    */
	    ...
	    // the "scales" stuff as a 2nd substitutable resource is fucked imho --sith
	    // we can always uncomment and add this later if we want to do alloying
	    ...
	    AddSubRes( typeof( IronIngot), 1044022, 0, 1044268 );
	    AddSubRes( typeof( GoldIngot ), 1160200, 1, 1044268 );
	    AddSubRes( typeof( SpikeIngot ), 1160201, 5, 1044268 );
	    AddSubRes( typeof( FruityIngot ), 1160202, 10, 1044268 );
	    AddSubRes( typeof( BronzeIngot ), 1160203, 15, 1044268 );
	    AddSubRes( typeof( IceRockIngot ), 1160204, 20, 1044268 );
	    AddSubRes( typeof( BlackDwarfIngot ), 1160205, 25, 1044268 );
	    AddSubRes( typeof( DullCopperIngot ), 1160206, 30, 1044268 );
	    AddSubRes( typeof( PlatinumIngot ), 1160207, 35, 1044268 );
	    AddSubRes( typeof( SilverRockIngot ), 1160208, 40, 1044268 );
	    AddSubRes( typeof( DarkPaganIngot ), 1160209, 45, 1044268 );
	    AddSubRes( typeof( CopperIngot ), 1160210, 50, 1044268 );
	    AddSubRes( typeof( MysticIngot ), 1160211, 55, 1044268 );
	    AddSubRes( typeof( SpectralIngot ), 1160212, 60, 1044268 );
	    AddSubRes( typeof( OldBritainIngot ), 1160213, 65, 1044268 );
	    AddSubRes( typeof( OnyxIngot ), 1160214, 70, 1044268 );
	    AddSubRes( typeof( RedElvenIngot ), 1160215, 75, 1044268 );
	    AddSubRes( typeof( UndeadIngot ), 1160216, 80, 1044268 );
	    AddSubRes( typeof( PyriteIngot ), 1160217, 85, 1044268 );
	    AddSubRes( typeof( VirginityIngot ), 1160218, 90, 1044268 );
	    AddSubRes( typeof( MalachiteIngot ), 1160219, 95, 1044268 );
	    AddSubRes( typeof( LavarockIngot ), 1160220, 97, 1044268 );
	    AddSubRes( typeof( AzuriteIngot ), 1160221, 98, 1044268 );
	    AddSubRes( typeof( DripstoneIngot ), 1160222, 100, 1044268 );
	    AddSubRes( typeof( ExecutorIngot ), 1160223, 104, 1044268 );
	    AddSubRes( typeof( PeachblueIngot ), 1160224, 108, 1044268 );
	    AddSubRes( typeof( DestructionIngot ), 1160225, 112, 1044268 );
	    AddSubRes( typeof( AnraIngot ), 1160226, 116, 1044268 );
	    AddSubRes( typeof( CrystalIngot ), 1160227, 119, 1044268 );
	    AddSubRes( typeof( DoomIngot ), 1160228, 122, 1044268 );
	    AddSubRes( typeof( GoddessIngot ), 1160229, 125, 1044268 );
	    AddSubRes( typeof( NewZuluIngot ), 1160230, 129, 1044268 );
	    AddSubRes( typeof( EbonTwilightSapphireIngot ), 1160231, 130, 1044268 );
	    AddSubRes( typeof( DarkSableRubyIngot ), 1160232, 130, 1044268 );
	    AddSubRes( typeof( RadiantNimbusDiamondIngot ), 1160233, 140, 1044268 );
