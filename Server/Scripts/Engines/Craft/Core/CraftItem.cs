...
#region Tables
	...
	private static Type[][] m_TypesTable = new Type[][]
		...
		new Type[]{ typeof( PinetreeLog ), typeof( PinetreeBoard ) },
		new Type[]{ typeof( CherryLog ), typeof( CherryBoard ) },
		new Type[]{ typeof( OakLog ), typeof( OakBoard ) },
		new Type[]{ typeof( PurplePassionLog ), typeof( PurplePassionBoard ) },
		new Type[]{ typeof( GoldenReflectionLog ), typeof( GoldenReflectionBoard ) },
		new Type[]{ typeof( HardrangerLog ), typeof( HardrangerBoard ) },
		new Type[]{ typeof( JadewoodLog ), typeof( JadewoodBoard ) },
		new Type[]{ typeof( DarkwoodLog ), typeof( DarkwoodBoard ) },
		new Type[]{ typeof( StonewoodLog ), typeof( StonewoodBoard ) },
		new Type[]{ typeof( SunwoodLog ), typeof( SunwoodBoard ) },
		new Type[]{ typeof( GauntletLog ), typeof( GauntletBoard ) },
		new Type[]{ typeof( SwampwoodLog ), typeof( SwampwoodBoard ) },
		new Type[]{ typeof( StardustLog ), typeof( StardustBoard ) },
		new Type[]{ typeof( SilverleafLog ), typeof( SilverleafBoard ) },
		new Type[]{ typeof( StormtealLog ), typeof( StormtealBoard ) },
		new Type[]{ typeof( EmeraldwoodLog ), typeof( EmeraldwoodBoard ) },
		new Type[]{ typeof( BloodwoodLog ), typeof( BloodwoodBoard ) },
		new Type[]{ typeof( CrystalwoodLog ), typeof( CrystalwoodBoard ) },
		new Type[]{ typeof( BloodhorseLog ), typeof( BloodhorseBoard ) },
		new Type[]{ typeof( DoomwoodLog ), typeof( DoomwoodBoard ) },
		new Type[]{ typeof( ZuluLog ), typeof( ZuluBoard ) },
		new Type[]{ typeof( DarknessLog ), typeof( DarknessBoard ) },
