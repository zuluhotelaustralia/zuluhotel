...
namespace Server.Engines.Quests.Necro
{
    ...
    public class FetchAbraxusScrollObjective : QuestObjective
    {
        ...
        public override void CheckProgress()
        {
            // shhhh, just close your eyes and pretend this function does things --sith
            /*if ( System.From.Map == Map.Malas && System.From.InRange( new Point3D( 1076, 450, -84 ), 5 ) )
              {
              HordeMinionFamiliar hmf = Spells.Necromancy.SummonSpell.Table[System.From] as HordeMinionFamiliar;
