...
{
    public class GatherResultsTimer : Timer {
	...
	public GatherResultsTimer( Mobile from, Item tool, GatherSystem system, GatherNode node, object targeted, object locked, TimeSpan delay ) : base ( delay ){
	    m_System = system;
	    m_From = from;
	    m_Tool = tool;
	    m_Targeted = targeted;
