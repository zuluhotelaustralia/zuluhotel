...
namespace Server.Engines.Gather
{
	...
	private void SpawnLumberjackingNodes( GatherSystemController stone ) {
	    ...
	    stone.System.AddNode( new GatherNode( thronex, throney, 3, 7, 0.8, 140.0, 95.0, 125.0, typeof( SunLog ) ) );
	    stone.System.AddNode( new GatherNode( thronex, throney, 6, 1, 0.7, 130.0, 100.0, 130.0, typeof( GauntletLog ) ) );
	    stone.System.AddNode( new GatherNode( thronex, throney, 7, 10, 0.7, 120.0, 105.0, 135.0, typeof( SwampLog ) ) );
	    ...
	    stone.System.AddNode( new GatherNode( thronex, throney, 4, 1, 0.6, 79.0, 114.0, 144.0, typeof( BloodLog ) ) );
	    stone.System.AddNode( new GatherNode( thronex, throney, 2, 5, 0.6, 78.0, 115.0, 145.0, typeof( CrystalLog ) ) );
	    stone.System.AddNode( new GatherNode( thronex, throney, 10, 7, 0.5, 77.0, 116.0, 146.0, typeof( BloodhorseLog ) ) );
	    stone.System.AddNode( new GatherNode( thronex, throney, 5, 9, 0.5, 76.0, 117.0, 147.0, typeof( DoomLog ) ) );
