...
{
    public class TreasureMap : RelPorMapItem
    {
	private int m_Level;
	...
	private static Type[][] m_SpawnTypes = new Type[][]
		...
		new Type[]{ typeof( OrcishMage ), typeof( VanillaGargoyle ), typeof( Gazer ), typeof( HellHound ), typeof( EarthElemental ) },
	...
	public const double LootChance = 0.01;
