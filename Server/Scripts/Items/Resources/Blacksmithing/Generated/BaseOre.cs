...
namespace Server.Items
{
	...
	private class InternalTarget : Target
	{
		...
		if ( IsForge( targeted ) )
		{
			...
			case CraftResource.Iron: difficulty = 0.0; break;
			case CraftResource.Gold: difficulty = 1.0; break;
			case CraftResource.Spike: difficulty = 5.0; break;
			case CraftResource.Fruity: difficulty = 10.0; break;
			case CraftResource.Bronze: difficulty = 15.0; break;
			case CraftResource.IceRock: difficulty = 20.0; break;
			case CraftResource.BlackDwarf: difficulty = 25.0; break;
			case CraftResource.DullCopper: difficulty = 30.0; break;
			case CraftResource.Platinum: difficulty = 35.0; break;
			case CraftResource.SilverRock: difficulty = 40.0; break;
			case CraftResource.DarkPagan: difficulty = 45.0; break;
			case CraftResource.Copper: difficulty = 50.0; break;
			case CraftResource.Mystic: difficulty = 55.0; break;
			case CraftResource.Spectral: difficulty = 60.0; break;
			case CraftResource.OldBritain: difficulty = 65.0; break;
			case CraftResource.Onyx: difficulty = 70.0; break;
			case CraftResource.RedElven: difficulty = 75.0; break;
			case CraftResource.Undead: difficulty = 80.0; break;
			case CraftResource.Pyrite: difficulty = 85.0; break;
			case CraftResource.Virginity: difficulty = 90.0; break;
			case CraftResource.Malachite: difficulty = 95.0; break;
			case CraftResource.Lavarock: difficulty = 97.0; break;
			case CraftResource.Azurite: difficulty = 98.0; break;
			case CraftResource.Dripstone: difficulty = 100.0; break;
			case CraftResource.Executor: difficulty = 104.0; break;
			case CraftResource.Peachblue: difficulty = 108.0; break;
			case CraftResource.Destruction: difficulty = 112.0; break;
			case CraftResource.Anra: difficulty = 116.0; break;
			case CraftResource.Crystal: difficulty = 119.0; break;
			case CraftResource.Doom: difficulty = 122.0; break;
			case CraftResource.Goddess: difficulty = 125.0; break;
			case CraftResource.NewZulu: difficulty = 129.0; break;
			case CraftResource.EbonTwilightSapphire: difficulty = 130.0; break;
			case CraftResource.DarkSableRuby: difficulty = 130.0; break;
			case CraftResource.RadiantNimbusDiamond: difficulty = 140.0; break;
		    }
