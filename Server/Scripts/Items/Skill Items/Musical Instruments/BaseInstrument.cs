...
namespace Server.Items
{
    ...
    public abstract class BaseInstrument : Item, ICraftable, ISlayer
    {
        ...
        {
            m.CheckSkill(SkillName.Musicianship, 0.0, 130.0);

            return ((m.Skills[SkillName.Musicianship].Value / 130) > Utility.RandomDouble());
        }
        ...
        public int OnCraft(int quality, bool makersMark, Mobile from, CraftSystem craftSystem, Type typeRes, BaseTool tool, CraftItem craftItem, int resHue)
        {
            ...
            Type restype = typeRes;

            if (restype == null)
            {
                restype = craftItem.Resources.GetAt(0).ItemType;
            }

            Resource = CraftResources.GetFromType(restype);
