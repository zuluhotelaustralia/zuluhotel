...
namespace Server.SkillHandlers
{
    public class Hiding
    {
        ...
        public static TimeSpan OnUse(Mobile m)
        {
            ...
            int range = Math.Min((int)((150 - m.Skills[SkillName.Hiding].Value) / 2) + 8, 18);  //Cap of 18 not OSI-exact, intentional difference
            ...
            if (ok)
            {
                ...
                ok = (!badCombat && m.CheckSkill(SkillName.Hiding, 0.0, 130.0 - bonus));
            }
