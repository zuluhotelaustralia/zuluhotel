...
#region Mondain's Legacy
	...
	private static Type[] m_JewelryTypes = new Type[]
	    {
		typeof( GoldRing ),				typeof( GoldBracelet ), typeof( GoldEarrings ),
		typeof( SilverRing ),			typeof( SilverBracelet ), typeof( SilverEarrings )
	    };
	...
	private static Type[] m_NecroRegTypes = new Type[]
	    {
		typeof( BatWing ), typeof( DaemonBlood ), typeof( NoxCrystal ), typeof( PigIron )
	    };
	public static Type[] NecroRegTypes{ get{ return m_NecroRegTypes; } }

	private static Type[] m_PaganTypes = new Type[]
	    {
