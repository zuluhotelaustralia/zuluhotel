...
namespace Server
{
    ...
    {
        private static Rectangle2D[] m_SosariaRegions = new Rectangle2D[]
        {
        new Rectangle2D( new Point2D( 0, 0 ), new Point2D( 2500, 2500 ) )
        };
        ...
        public static void Generate()
        {
            ...
            */
            ...
            World.Broadcast(0x35, true, "Door generation complete. Trammel: {0}; Felucca: {1}; Ilshenar: {2}; Malas: {3};", 0, feluccaCount, 0, 0);
        }
