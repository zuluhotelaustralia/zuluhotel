...
namespace Server.Gumps {
	...
	public MOTDGump( Mobile from ) : base( 100, 100 ){
	    ...
	    AddHtml( 10, 10, 460, 100, "<h2>Shard Update News: 29 March 2020</h2>", false, false );
	    ...
	    AddHtml( 10, 200, 460, 140, "Recent changes: Client was updated.  If you are seeing strange animations where trees should be, then please visit the website downloads section.", false, false );
