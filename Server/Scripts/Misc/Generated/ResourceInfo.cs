...
namespace Server.Items
{
	...
	private static CraftResourceInfo[] m_MetalInfo = new CraftResourceInfo[]
		...
		new CraftResourceInfo( 0x885, 1053109, "gold", CraftAttributeInfo.Gold, CraftResource.Gold, typeof( GoldIngot ), typeof( GoldOre), typeof( GoldGranite ) ),
		new CraftResourceInfo( 0x4c7, 1053109, "spike", CraftAttributeInfo.Spike, CraftResource.Spike, typeof( SpikeIngot ), typeof( SpikeOre), typeof( SpikeGranite ) ),
		new CraftResourceInfo( 0x46e, 1053109, "fruity", CraftAttributeInfo.Fruity, CraftResource.Fruity, typeof( FruityIngot ), typeof( FruityOre), typeof( FruityGranite ) ),
		new CraftResourceInfo( 0x45e, 1053109, "bronze", CraftAttributeInfo.Bronze, CraftResource.Bronze, typeof( BronzeIngot ), typeof( BronzeOre), typeof( BronzeGranite ) ),
		new CraftResourceInfo( 0x480, 1053109, "ice rock", CraftAttributeInfo.IceRock, CraftResource.IceRock, typeof( IceRockIngot ), typeof( IceRockOre), typeof( IceRockGranite ) ),
		new CraftResourceInfo( 0x451, 1053109, "black dwarf", CraftAttributeInfo.BlackDwarf, CraftResource.BlackDwarf, typeof( BlackDwarfIngot ), typeof( BlackDwarfOre), typeof( BlackDwarfGranite ) ),
		new CraftResourceInfo( 0x3ea, 1053109, "dull copper", CraftAttributeInfo.DullCopper, CraftResource.DullCopper, typeof( DullCopperIngot ), typeof( DullCopperOre), typeof( DullCopperGranite ) ),
		new CraftResourceInfo( 0x457, 1053109, "platinum", CraftAttributeInfo.Platinum, CraftResource.Platinum, typeof( PlatinumIngot ), typeof( PlatinumOre), typeof( PlatinumGranite ) ),
		new CraftResourceInfo( 0x3e9, 1053109, "silver rock", CraftAttributeInfo.SilverRock, CraftResource.SilverRock, typeof( SilverRockIngot ), typeof( SilverRockOre), typeof( SilverRockGranite ) ),
		new CraftResourceInfo( 0x46b, 1053109, "dark pagan", CraftAttributeInfo.DarkPagan, CraftResource.DarkPagan, typeof( DarkPaganIngot ), typeof( DarkPaganOre), typeof( DarkPaganGranite ) ),
		new CraftResourceInfo( 0x602, 1053109, "copper", CraftAttributeInfo.Copper, CraftResource.Copper, typeof( CopperIngot ), typeof( CopperOre), typeof( CopperGranite ) ),
		new CraftResourceInfo( 0x17f, 1053109, "mystic", CraftAttributeInfo.Mystic, CraftResource.Mystic, typeof( MysticIngot ), typeof( MysticOre), typeof( MysticGranite ) ),
		new CraftResourceInfo( 0x483, 1053109, "spectral", CraftAttributeInfo.Spectral, CraftResource.Spectral, typeof( SpectralIngot ), typeof( SpectralOre), typeof( SpectralGranite ) ),
		new CraftResourceInfo( 0x852, 1053109, "old britain", CraftAttributeInfo.OldBritain, CraftResource.OldBritain, typeof( OldBritainIngot ), typeof( OldBritainOre), typeof( OldBritainGranite ) ),
		new CraftResourceInfo( 0x455, 1053109, "onyx", CraftAttributeInfo.Onyx, CraftResource.Onyx, typeof( OnyxIngot ), typeof( OnyxOre), typeof( OnyxGranite ) ),
		new CraftResourceInfo( 0x4b9, 1053109, "red elven", CraftAttributeInfo.RedElven, CraftResource.RedElven, typeof( RedElvenIngot ), typeof( RedElvenOre), typeof( RedElvenGranite ) ),
		new CraftResourceInfo( 0x279, 1053109, "undead", CraftAttributeInfo.Undead, CraftResource.Undead, typeof( UndeadIngot ), typeof( UndeadOre), typeof( UndeadGranite ) ),
		new CraftResourceInfo( 0x6b8, 1053109, "pyrite", CraftAttributeInfo.Pyrite, CraftResource.Pyrite, typeof( PyriteIngot ), typeof( PyriteOre), typeof( PyriteGranite ) ),
		new CraftResourceInfo( 0x482, 1053109, "virginity", CraftAttributeInfo.Virginity, CraftResource.Virginity, typeof( VirginityIngot ), typeof( VirginityOre), typeof( VirginityGranite ) ),
		new CraftResourceInfo( 0x487, 1053109, "malachite", CraftAttributeInfo.Malachite, CraftResource.Malachite, typeof( MalachiteIngot ), typeof( MalachiteOre), typeof( MalachiteGranite ) ),
		new CraftResourceInfo( 0x486, 1053109, "lavarock", CraftAttributeInfo.Lavarock, CraftResource.Lavarock, typeof( LavarockIngot ), typeof( LavarockOre), typeof( LavarockGranite ) ),
		new CraftResourceInfo( 0x4df, 1053109, "azurite", CraftAttributeInfo.Azurite, CraftResource.Azurite, typeof( AzuriteIngot ), typeof( AzuriteOre), typeof( AzuriteGranite ) ),
		new CraftResourceInfo( 0x49e, 1053109, "dripstone", CraftAttributeInfo.Dripstone, CraftResource.Dripstone, typeof( DripstoneIngot ), typeof( DripstoneOre), typeof( DripstoneGranite ) ),
		new CraftResourceInfo( 0x499, 1053109, "executor", CraftAttributeInfo.Executor, CraftResource.Executor, typeof( ExecutorIngot ), typeof( ExecutorOre), typeof( ExecutorGranite ) ),
		new CraftResourceInfo( 0x49c, 1053109, "peachblue", CraftAttributeInfo.Peachblue, CraftResource.Peachblue, typeof( PeachblueIngot ), typeof( PeachblueOre), typeof( PeachblueGranite ) ),
		new CraftResourceInfo( 0x500, 1053109, "destruction", CraftAttributeInfo.Destruction, CraftResource.Destruction, typeof( DestructionIngot ), typeof( DestructionOre), typeof( DestructionGranite ) ),
		new CraftResourceInfo( 0x48b, 1053109, "anra", CraftAttributeInfo.Anra, CraftResource.Anra, typeof( AnraIngot ), typeof( AnraOre), typeof( AnraGranite ) ),
		new CraftResourceInfo( 0x492, 1053109, "crystal", CraftAttributeInfo.Crystal, CraftResource.Crystal, typeof( CrystalIngot ), typeof( CrystalOre), typeof( CrystalGranite ) ),
		new CraftResourceInfo( 0x49f, 1053109, "doom", CraftAttributeInfo.Doom, CraftResource.Doom, typeof( DoomIngot ), typeof( DoomOre), typeof( DoomGranite ) ),
		new CraftResourceInfo( 0x501, 1053109, "goddess", CraftAttributeInfo.Goddess, CraftResource.Goddess, typeof( GoddessIngot ), typeof( GoddessOre), typeof( GoddessGranite ) ),
		new CraftResourceInfo( 0x488, 1053109, "new zulu", CraftAttributeInfo.NewZulu, CraftResource.NewZulu, typeof( NewZuluIngot ), typeof( NewZuluOre), typeof( NewZuluGranite ) ),
		new CraftResourceInfo( 0x493, 1053109, "ebon twilight sapphire", CraftAttributeInfo.EbonTwilightSapphire, CraftResource.EbonTwilightSapphire, typeof( EbonTwilightSapphireIngot ), typeof( EbonTwilightSapphireOre), typeof( EbonTwilightSapphireGranite ) ),
		new CraftResourceInfo( 0x494, 1053109, "dark sable ruby", CraftAttributeInfo.DarkSableRuby, CraftResource.DarkSableRuby, typeof( DarkSableRubyIngot ), typeof( DarkSableRubyOre), typeof( DarkSableRubyGranite ) ),
		new CraftResourceInfo( 0x498, 1053109, "radiant nimbus diamond", CraftAttributeInfo.RadiantNimbusDiamond, CraftResource.RadiantNimbusDiamond, typeof( RadiantNimbusDiamondIngot ), typeof( RadiantNimbusDiamondOre), typeof( RadiantNimbusDiamondGranite ) ),
	    };
