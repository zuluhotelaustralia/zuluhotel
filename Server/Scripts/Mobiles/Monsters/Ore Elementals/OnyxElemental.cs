...
namespace Server.Mobiles
{
    ...
    public class OnyxElemental : BaseCreature
    {
        [Constructable]
        public OnyxElemental() : this(2)
        {
        }

        [Constructable]
        public OnyxElemental(int oreAmount) : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "an onyx elemental";
            Body = 107;
            BaseSoundID = 268;
            ...
            Item ore = new OnyxOre(oreAmount);
            ore.ItemID = 0x19B9;
            PackItem(ore);
        }
        ...
        public OnyxElemental(Serial serial) : base(serial)
        {
        }
