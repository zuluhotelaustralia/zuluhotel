...
namespace Server.Mobiles
{
	...
	*/
	...
	public virtual bool IsNecroFamiliar
	{
		...
		if ( !Summoned )
		    return false;
		//This function might come in handy later since Summon Spirit and Control Undead are a thing  --sith
	...
	*/
	...
	public override void Deserialize( GenericReader reader )
	{
	    ...
	    /* // might need this for ControlUndead --sith
	       if ( IsAnimatedDead )
	...
	public override void OnAfterDelete()
	{
	    ...
	    // again, might need this for ControlUndead or perhaps SummonSpirit --sith
	    /*if ( IsAnimatedDead )
