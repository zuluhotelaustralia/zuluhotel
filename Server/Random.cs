...
namespace Server {
    ...
    // sith's todo: all these XYZCryptoServiceProviders are assumed to be from a CAPI on Windows
    //  in .net core they have been replaced with e.g. RandomNumberGenerator class
    public sealed class CSPRandom : IRandomImpl {
	private RandomNumberGenerator _CSP = RandomNumberGenerator.Create();
