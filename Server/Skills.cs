...
namespace Server
{
    ...
    public class SkillInfo
    {
        ...
        //SkillInfo( int skillID, string name, double strScale, double dexScale, double intScale, string title, SkillUseCallback callback, double strGain, double dexGain, double intGain, double gainFactor )
        ...
        new SkillInfo(  9, "Peacemaking",       0.0,    0.0,    0.0,    "Pacifist",     null,   0.0,    0.0,    0.0,    1.0 ),
