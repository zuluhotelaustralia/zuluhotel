...
* TODO make a battle-royale minigame a la pubg for beta players to have fun pvping [9/10]
:PROPERTIES:
...
** DONE disable guards
** TODO make a better spawner that will spawn all loot uniformly at first, then later revise to have loot levels to encourage hotspots
