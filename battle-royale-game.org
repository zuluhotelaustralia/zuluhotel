...
* TODO make a battle-royale minigame a la pubg for beta players to have fun pvping [15/19]
:PROPERTIES:
...
** DONE balance the loot for other classes
** DONE make "bag of potions" item -> spawn it
